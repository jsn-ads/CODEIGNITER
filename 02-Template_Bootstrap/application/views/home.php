			...
			<div class="container">
				<div class="slider-container">
					<div class="intro-text">
						<div class="intro-lead-in a">Bem Vindo ao Curso Mobile</div>
						<div class="intro-heading a">Curso B7WEB</div>
						<a href="#about" class="page-scroll btn btn-xl a">Começe Agora</a>
					</div>
				</div>
			</div>
		</header>
		...
		<section id="portfolio" class="light-bg">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?= BASE_URL();?>public/images/demo/portfolio-1.jpg" alt="<?= BASE_URL();?>img02" class="img-responsive" />
							<figcaption>
								<h2>Dean & Letter</h2>
								<p>Branding, Design</p>
				...
				<div class="col-md-4">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?= BASE_URL();?>public/images/demo/portfolio-2.jpg" alt="<?= BASE_URL();?>img02" class="img-responsive" />
							<figcaption>
				...
				<div class="col-md-4">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?= BASE_URL();?>public/images/demo/portfolio-3.jpg" alt="<?= BASE_URL();?>img02" class="img-responsive" />
							<figcaption>
								<h2>Lamp & Velvet</h2>
								<p>Branding, Web Design</p>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?= BASE_URL();?>public/images/demo/portfolio-4.jpg" alt="<?= BASE_URL();?>img02" class="img-responsive" />
							<figcaption>
								<h2>Smart Name</h2>
								<p>Branding, Design</p>
				...
				<div class="col-md-4">
					<div class="ot-portfolio-item">
						<figure class="effect-bubba">
							<img src="<?= BASE_URL();?>public/images/demo/portfolio-5.jpg" alt="<?= BASE_URL();?>img02" class="img-responsive" />
							<figcaption>
								<h2>Fast People</h2>
								<p>Branding, Web Design</p>
